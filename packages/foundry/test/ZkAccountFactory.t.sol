...
contract ZkAccountFactoryTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy factory
        factory = new ZkAccountFactory(IEntryPoint(address(mockEntryPoint)), mockVerifier);
    ...
    function testZkVerifierFailurePreventsDeployment() public {
        ...
        ZkAccountFactory failingFactory = new ZkAccountFactory(IEntryPoint(address(mockEntryPoint)), failingVerifier);
    ...
    function testFactoryWithDifferentVerifiers() public {
        ...
        ZkAccountFactory factory2 = new ZkAccountFactory(IEntryPoint(address(mockEntryPoint)), verifier2);
